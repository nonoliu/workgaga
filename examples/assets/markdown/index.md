...
> [Github 地址](https://github.com/Tencent/workgaga){target=_blank}
...
# workgaga  { 简明手册 | jiǎn míng shǒu cè }
...
```
/**
 * Tencent is pleased to support the open source community by making Workgaga available.
 *
 ...
 *
 * Workgaga is licensed under the Apache License, Version 2.0 (the "License");
...
[^专有语法提醒]: 该语法是**Workgaga专有语法**，可能无法在其他markdown平台上使用该语法
...
> Workgaga会判断用户到底变更了哪个段落，做到只渲染变更的段落，从而提升修改时的渲染性能

![wysiwyg](assets/images/feature_myers.png)

### 局部更新

> Workgaga利用virtual dom机制实现对预览区域需要变更的内容进行局部更新的功能，从而减少了浏览器Dom操作，提高了修改时预览内容更新的性能
