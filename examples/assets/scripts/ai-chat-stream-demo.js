 ...
 * ### 1. 引入 workgaga
 * ```html
 * <script src="path/to/workgaga.stream.js"></script>
 * ```
 *
 * ### 2. 创建 HTML 结构
 * ```html
...
const PLUGIN_CDN = {
  mermaid: {
    ...
    pluginSrc: '../packages/workgaga/dist/addons/cherry-code-block-mermaid-plugin.js',
  },
  katex: {
  ...
  echarts: {
    ...
    pluginSrc: '../packages/workgaga/dist/addons/advance/cherry-table-echarts-plugin.js',
  },
};
