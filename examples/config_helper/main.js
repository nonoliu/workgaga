...
function updatePreview() {
  ...
  config.value = configState['value']?.value || '# Hello workgaga!';
  ...
  if (sourceCode) {
    sourceContent.innerHTML = `
      ...
      <div class="mt-4 pt-4 border-t border-gray-700">
        ...
        <a href="https://github.com/Tencent/workgaga/blob/dev/packages/workgaga/src/Cherry.config.js"
